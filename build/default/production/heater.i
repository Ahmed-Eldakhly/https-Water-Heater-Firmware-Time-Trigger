...
void Heater_On_Off_Button_Task(void)
{
    ...
    Check_ON_Push_Button(1u , 0u , &On_Off_Button);
    switch(g_Heater_state_t)
    {
        case HEATER_OFF_STATE:
            if(On_Off_Button == PUSH_BUTTON_IS_PRESSED)
            {
                ...
                u8Saved_temperature_in_EEPROM = EEPROM_Read_Byte(25u);
...
void Heater_Up_Down_Buttons_Task(void)
{
    ...
    switch(g_Heater_state_t)
    {
        ...
        case HEATER_ON_STATE:
            ...
            if(Check_ON_Push_Button(1u , 1u , &Down_Button) == PUSH_BUTTON_IS_PRESSED ||
               Check_ON_Push_Button(1u , 2u , &Up_Button) == PUSH_BUTTON_IS_PRESSED)
            {
        ...
        case HEATER_SET_TEMERATURE:
            ...
            if(Check_ON_Push_Button(1u , 1u , &Down_Button) == PUSH_BUTTON_IS_PRESSED)
            {
                ...
                if(g_u8Heater_desired_temperature > 35u)
                {

                    g_u8Heater_desired_temperature -= 5;

                    EEPROM_Save_Byte(25u , g_u8Heater_desired_temperature);
                }
                else
                {
            ...
            else if(Check_ON_Push_Button(1u , 2u , &Up_Button) == PUSH_BUTTON_IS_PRESSED)
            {
                ...
                if(g_u8Heater_desired_temperature < 75u)
                {
